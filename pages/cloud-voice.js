                            ...
                            <div className="row d-flex align-items-center">
                              <div className="col-md-6 col-lg-6 col-sm-12 text-center pt-4">
                                    <div className="txt-block pc-25 mb-40">
                                        <h4 className="h4-xl pt-2 text-white">AI enabled Call Management System</h4>
                                        <p className="text-white">
                                            Revamp your communication approach, with our cutting edge AI enabled voice control 
                                            system that raises the bar for interaction.
                                        </p>
                                    </div>
                              </div>
                            ...
                            <div className="row d-flex align-items-center justify-content-center">
                              <div className="col-md-offset-7 col-md-7 col-sm-12 text-center">
                                    <div className="txt-block">
                                        {/* Title */}
                                        <h4 className="h4-xl pt-4 text-dark">Innovative Call Management Solutions by Telesourcenow</h4>
                                        {/* Text */}
                                        <p className="text-dark">
                                            Boost your business with a custom AI-enabled call management solution, Telesourcenow 

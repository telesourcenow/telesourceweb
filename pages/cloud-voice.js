            ...
            <Layout headerStyle={1} footerStyle={2} headerCls="white-menu navbar-dark">
                ...
                <section  className="pt-80 pb-30 services-section division">
                        <div className="container">
                            <div className="row first-cloud-service-row text-justify">
                                ...
                                <div className="col-sm-12 col-lg-4">
                                        <div className="sbox-2">
                                            <h5 className="h5-md text-white">Intractiv Voice Record</h5>
                                            <p className="p-sm text-justify">
                                ...
                                <div className="row second-cloud-service-row">
                                <div className="col-sm-12 col-lg-4">
                                        <div className="sbox-2">
                                ...
                                <div className="row third-cloud-service-row">
                                <div className="col-sm-12 col-lg-4">
                                        <div className="sbox-2">
                                ...
                                <div className="row fourth-cloud-service-row">
                                <div className="col-sm-12 col-lg-4">
                                        <div className="sbox-2">
                                            <h5 className="h5-md text-white">Progressive & Predictive Dialer</h5>
                                            <p className="p-sm text-justify">

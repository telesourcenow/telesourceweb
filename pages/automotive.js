                                        ...
                                        <div>
                                            <div class="card">
                                                <div class="content">
                                                    ...
                                                    <p class="para">
                                                        AI assistants answer basic car questions, suggest models, and schedule test drives, while 
                                                        agents handle complex inquiries and build rapport.
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div>
                                            <div class="card">
                                                <div class="content">
                                                    ...
                                                    <p class="para">
                                                        Chatbots are always available for roadside assistance, service booking, and general inquiries.
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div>
                                            <div class="card">
                                                <div class="content">
                                                    ...
                                                    <h4 className="text-white">Streamlined Services</h4>
                                                    <p class="para">
                                                        AI automates tasks like service reminders and appointment scheduling, boosting efficiency.
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div>
                                            <div class="card">
                                                <div class="content">
                                                    ...
                                                    <h4 className="text-white">AI Ethics & Privacy</h4>
                                                    <p class="para">
                                                        Ethical considerations and data privacy remain key along with ongoing AI development.
                                                    </p>
                                                </div>
                                            </div>
                                        </div>

                            ...
                            <div className="row d-flex align-items-center">
                              <div className="col-md-12 col-lg-12 col-sm-12 text-center pt-4">
                                    <div className="txt-block pc-25 mb-40">
                                        <h4 className="h4-xl pt-2 text-white">Integrated Marketing Solutions</h4>
                                        <p className="text-white text-bolder"> 
                                            Integrated Marketing Solutions: Elevate brand visibility with Telesourcenow. 
                                        </p>
                                        <p className="text-white text-bolder">
                                            From strategic branding to multi-channel campaigns, we deliver tailored solutions 
                                            for growth
                                        </p>
                                    </div>
                              </div>

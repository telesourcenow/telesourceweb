            ...
            <header id="header" className={`header ${headerCls ? headerCls : ""}`}>
                <div className="header-wrapper">
                    ...
                    <div className="wsmobileheader clearfix">
                        ...
                        <span className="smllogo smllogo-black"><img src="/images/logo.png" width={200} height={100} alt="mobile-logo" /></span>
                        <span className="smllogo smllogo-white"><img src="/images/logo-white.png" width={200} height={100} alt="mobile-logo" /></span>
                    ...
                    <div className={`wsmainfull menu clearfix ${scroll ? "scroll" : ""}`}>
                        <div className="wsmainwp clearfix">
                            ...
                            <div className="desktoplogo">
                                <Link href="/" className="logo-black"><img src="/images/logo.png" width={220} height={60} alt="header-logo" /></Link></div>
                            <div className="desktoplogo">
                                <Link href="/" className="logo-white"><img src="/images/logo-white.png" width={220} height={60} alt="header-logo" /></Link></div>
                            {/* MAIN MENU */}
